...
class ISNetGTEncoder(nn.Module):
    ...
    def forward(self,x):
        ...
        return [sigmoid(d1), sigmoid(d2), sigmoid(d3), sigmoid(d4), sigmoid(d5), sigmoid(d6)], [hx1,hx2,hx3,hx4,hx5,hx6]
...
class ISNetDIS(nn.Module):
    ...
    def forward(self,x):
        ...
        return [sigmoid(d1), sigmoid(d2), sigmoid(d3), sigmoid(d4), sigmoid(d5), sigmoid(d6)],[hx1d,hx2d,hx3d,hx4d,hx5d,hx6]
